...
namespace BlazorCCSE.Server.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required, DataType(DataType.Text), Display(Name = "Forename")]
            public string Forename { get; set; }

            [Required, DataType(DataType.Text), Display(Name = "Surname")]
            public string Surname { get; set; }

            [Required, DataType(DataType.Text), Display(Name = "Passport Number")]
            public string PassportNumber { get; set; }

            [Phone]
            [Required, DataType(DataType.Text), Display(Name = "Contact Number")]
